...
class AnomalyClassifier():
	...
	def save_the_array(self):
		np.savetxt('/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/myevaluateResults.csv', self.evaluateResults)
	...
	def evaluateOnTest(self,para8iro):
		...
		results1=np.loadtxt(open('/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/myassosSet.csv','rb')) #ksehorizei tin teleftaia stili tou testSet pou periehei tis pragmatikes apantiseis
		...
		print "\n-----APOTELESMATA-----"
		for key in self.apotelesmata.keys():
			print key,self.apotelesmata[key]
			
		w = csv.writer(open("/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/output.csv", "w"))
