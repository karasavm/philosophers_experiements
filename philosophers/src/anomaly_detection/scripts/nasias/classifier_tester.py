...
class ClassifierTester():
	def __init__(self,pinakasA): 
		x_pickled = open('/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/trained.pkl', 'rb')
...
if __name__ == "__main__":
	...
	if len(sys.argv)!=1 and sys.argv[1] == '-h':
		...
		#sys.exit()
	#	print len(sys.argv)
	pinakasA=np.loadtxt(open('/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/mytestSet.csv','rb')) #fortonei to testSet
