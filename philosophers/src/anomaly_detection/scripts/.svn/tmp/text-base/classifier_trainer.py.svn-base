...
if __name__ == "__main__":
	...
	if sys.argv[1] == '-h':
		print 'argv[1] = svm || gmm'
		print "argv[2] = window's width"
		sys.exit()
	
	pinakasA=np.loadtxt(open('/home/mike/svn/nasia/trunk/philosophers/src/anomaly_detection/scripts/results/mytrainSet.csv','rb')) #fortonei to trainet
