...
class ROC:
    ...
    def __init__(self, metrics, var_param, const_params):
        ...
        self.__iscomputed = False

    def create_roc(self, fig_title):
        
        self.__figure = fig_title
        pl.figure(fig_title)
        ...
        pl.text(0, 0, fig_title)
        return fig_title
    def export_roc(self, fig_name):

        pl.figure(self.__figure)
        pl.savefig(fig_name)


    def export_roc2(self, name):
