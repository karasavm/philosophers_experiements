...
if("TRUE" STREQUAL "TRUE")
  set(state_manager_SOURCE_PREFIX /home/mike/philosophers_experiments/philosophers/src/state_manager)
  set(state_manager_DEVEL_PREFIX /home/mike/philosophers_experiments/philosophers/devel)
  ...
  set(state_manager_INSTALL_PREFIX /home/mike/philosophers_experiments/philosophers/install)
...
if(NOT "/home/mike/philosophers_experiments/philosophers/src/state_manager/include" STREQUAL "")
  set(state_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/mike/philosophers_experiments/philosophers/src/state_manager/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'state_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/philosophers_experiments/philosophers/src/state_manager/${idir}'.  Ask the maintainer 'Afouras Triantafyllos <afourast@gmail.com>' to fix it.")
    endif()
